...
function Navbar({ toggleSidebar, handleSearch, toggleShownav }) {

  return (
    <nav className="navbar">
      <div className="hamburger-menu" onClick={window.innerWidth <= 850? toggleShownav : toggleSidebar} >
        <svg
      ...
      <div className="navbar-logo">
        ...
        <span className="pacifico-regular">GemsTube</span>
      </div>
...
Navbar.propTypes = {
  ...
  toggleShownav: PropTypes.func.isRequired,
};
